...
export default {
  ...
  methods: {
    ...
    async submit() {
      if (this.movie_name === "" || this.movie_ === "" || this.genre === "" || this.director === "" || this.actor === "" || this.rate === "" || this.img === "") {
      ...
      console.log(this.movie_name,this.genre,this.director, this.actor, this.movie_intro, this.rate, this.img)
